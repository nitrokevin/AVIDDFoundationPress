	...
	<div class="splide__track">
		<ul class="splide__list">
			<?php if (have_rows('people_repeater', 'options')) {
				while (have_rows('people_repeater', 'option')) {
					the_row();
	...
	<div class="splide__arrows splide__arrows--ltr">
		<button class="splide__arrow splide__arrow--prev" type="button" aria-label="Go to last slide" aria-controls="splide03-track">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
				<polygon points="23.82 11.33 31.69 19.2 5.23 19.2 5.23 20.8 31.69 20.8 23.82 28.67 24.96 29.81 34.77 20 24.96 10.19 23.82 11.33" />
			</svg>
