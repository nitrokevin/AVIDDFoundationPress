 ...
 *
 * Key Features:
 * - Reads color and gradient palettes via the WordPress theme.json API
 *   (wp_get_global_settings) rather than reading theme.json directly —
 *   respects child themes, theme inheritance, FSE, and WP caching.
...
/**
 * Internal helper: return theme color and gradient data via the WordPress API.
 * Cached statically for the duration of the request.
 *
 * @return array {
 *   'palette'   => array  Color palette entries from theme.json.
